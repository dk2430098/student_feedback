...
async function loadProfile() {
    try {
        ...
        if (data.success) {
            ...
            document.getElementById('p-role-display').textContent = user.role === 'supervisor' ? 'Student Supervisor' : user.role;
            document.getElementById('p-assigned').value = user.assignedHostel || 'General Campus';
